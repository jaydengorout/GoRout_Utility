...
var plain = _interopRequireWildcard(_is_plain_object);
...
var DataLayerHelper = helper.DataLayerHelper = function (dataLayer, opt_listener, opt_listenToPast) {
...
helper.buildAbstractModelInterface_ = function (dataLayerHelper) {
  return {
    'set': function set(key, value) {
      helper.merge_(helper.expandKeyValue_(key, value), dataLayerHelper.model_);
    },
